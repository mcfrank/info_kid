...
\hspace{6ex}
$\vcenter{\hbox{\includegraphics[width=3in]{figures/info_adults_lm_mod.pdf}}}$
...
\begin{figure}[tr]
\begin{center}
\includegraphics[width=6in]{figures/kids_barplot.pdf}
...
STRENGTHS AND LIMITATIONS OF THE MODEL RE STIMULUS COMPLEXITY, SALIENCE, ETC>
...
Stimulus items for all four target items in each of the experiments are shown in Figure \ref{fig:all_stims}. For each stimulus item (robots, dinosaurs, rockets, and bears) FIXME
